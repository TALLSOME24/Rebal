/**
 * Full setup for PortfolioAgent v8 (ADD: withdrawFees() for future RITUAL recovery):
...
async function main() {
  ...
  console.log("  PortfolioAgent v8 Setup");
  console.log("═".repeat(60));
  ...
  console.log("\n" + "═".repeat(60));
  console.log("  v8 setup DONE!  scheduleId:", schedId.toString());
