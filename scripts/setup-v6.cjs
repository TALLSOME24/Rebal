/**
 * Full setup for PortfolioAgent v6 (FIX [8] — separate HTTP executor in portfolio):
...
const AGENT      = "0x51bebdc4af5f6058d826fc8621a854e896c5e3ed"; // v6
...
async function main() {
  ...
  console.log("  PortfolioAgent v6 Setup");
  console.log("═".repeat(60));
  ...
  console.log("\n" + "═".repeat(60));
  console.log("  v6 setup DONE!  scheduleId:", schedId.toString());
